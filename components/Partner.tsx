...
export const Partner = () => {
  ...
  return (
    <div ref={ref} className='flex items-center w-full justify-center flex-col z-20 py-24'>
        <motion.h4
        ...
        <motion.div
          className="relative w-full flex gap-10 justify-evenly items-center"
          ...
          {['partner01', 'partner02', 'partner03', 'partner04', 'partner05', 'partner06'].map((partner, index) => (
            <motion.div key={index} className={styles.imageContainer} variants={itemVariants} object-fit="contain">
              <Image
                ...
                width={100} // Arbitrary values that preserve the aspect ratio
                height={28}
              />
            </motion.div>
          ))}
